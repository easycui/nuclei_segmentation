...
## Licence
The code is licensed under [MIT](https://github.com/easycui/nuclei_segmentation/blob/master/LICENSE). Copyright (c) 2018.　The dataset is downloaded from https://nucleisegmentationbenchmark.weebly.com/dataset.html.
